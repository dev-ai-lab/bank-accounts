...
@Tag(
        name = "REST APIs for bank accounts",
        description = "REST APIs in bank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    /*
      RequestEntity<T>, @RequestHeader @RequestBody
     */
    @PostMapping("/create")
    ...
    public ResponseEntity<String> getBuildInfo() throws Exception {
        ...
        //throw new TimeoutException(); // Only this exception will trigger retries
        return ResponseEntity
                    .status(HttpStatus.OK)
                    .body(buildVersion);
    }

    // It should be of the same signature like getBuildInfo
